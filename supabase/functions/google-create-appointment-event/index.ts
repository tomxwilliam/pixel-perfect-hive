...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const eventData = {
      ...
      description: `Appointment with ${appointment.name}${appointment.email ? `\nEmail: ${appointment.email}` : ''}${appointment.phone ? `\nPhone: ${appointment.phone}` : ''}${appointment.notes ? `\n\nNotes: ${appointment.notes}` : ''}`,
      start: {
    ...
    console.log('Creating appointment calendar event:', eventData);
    ...
    console.log('Appointment calendar event created successfully:', eventResult.id);
    ...
    console.error('Create appointment event error:', error);
    return new Response(
