...
-- Update existing project_tasks table
...
-- Update status and priority columns to use enums if they're not already
ALTER TABLE project_tasks ALTER COLUMN status DROP DEFAULT;
ALTER TABLE project_tasks ALTER COLUMN status TYPE task_status_type USING status::task_status_type;
ALTER TABLE project_tasks ALTER COLUMN status SET DEFAULT 'todo';

ALTER TABLE project_tasks ALTER COLUMN priority DROP DEFAULT;
ALTER TABLE project_tasks ALTER COLUMN priority TYPE task_priority_type USING priority::task_priority_type;
