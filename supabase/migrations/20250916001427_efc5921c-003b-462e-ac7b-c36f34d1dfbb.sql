-- First update the check constraint to allow 'enom'
...
CHECK (integration_type IN ('stripe', 'paypal', 'google', 'microsoft', 'github', 'twitter', 'facebook', 'instagram', 'linkedin', 'tiktok', 'youtube', 'twitch', 'discord', 'slack', 'notion', 'airtable', 'zapier', 'mailchimp', 'sendgrid', 'aws', 'openprovider', 'enom'));
