...
('Basic Website', 'Standard business website with 5-10 pages', 'web_development', 2500.00, 30, '{"pages": ["Home", "About", "Services", "Contact"], "features": ["responsive_design", "contact_form", "seo_basics"]}'),
('E-commerce Store', 'Full e-commerce solution with payment integration', 'web_development', 8000.00, 60, '{"pages": ["Home", "Shop", "Product Pages", "Cart", "Checkout"], "features": ["payment_gateway", "inventory_management", "user_accounts"]}'),
('Mobile App MVP', 'Minimum viable product for mobile application', 'app_development', 15000.00, 90, '{"platforms": ["iOS", "Android"], "features": ["user_authentication", "core_functionality", "basic_ui"]}'),
('Custom Web Application', 'Bespoke web application development', 'web_development', 12000.00, 75, '{"features": ["user_management", "database_integration", "api_development", "admin_panel"]}'),
('Game Prototype', 'Basic game prototype and concept validation', 'game_development', 5000.00, 45, '{"platforms": ["PC", "Mobile"], "features": ["core_gameplay", "basic_graphics", "sound_effects"]}');

-- Add some sample project data for testing (optional)
