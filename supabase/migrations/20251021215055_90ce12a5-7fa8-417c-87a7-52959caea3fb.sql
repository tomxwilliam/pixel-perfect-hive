-- Fix approve_project function to cast project_type to text when calling create_default_project_tasks
...
BEGIN
  ...
  IF approval_decision = 'approved' THEN
    -- Cast project_type enum to text for the function call
    PERFORM create_default_project_tasks(project_id_param, project_record.project_type::text);
