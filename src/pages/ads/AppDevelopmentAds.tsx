...
export default function AppDevelopmentAds() {
  ...
  return (
    <GoogleAdsLandingTemplate
      ...
      description="From idea to App Store in 6 weeks. Cross-platform, secure, scalable mobile apps starting at £999. 80+ apps launched with 2M+ downloads."
      
      headline="Build Your Mobile App - iOS & Android"
      subheadline="From Idea to App Store in 6 Weeks - Starting at £999"
