  ...
  return <>
      ...
      <section className="relative min-h-screen flex items-start justify-center px-4 pt-12">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-background dark:text-foreground drop-shadow-[0_0_10px_rgba(0,0,0,0.8)] py-[15px] md:whitespace-nowrap md:ml-[-5%] mx-auto">
