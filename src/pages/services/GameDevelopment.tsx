...
export default function GameDevelopment() {
  const seoData = {
    title: "Professional Game Development Services | Unity & Unreal | 404 Code Lab",
    description: "Custom mobile game development for iOS and Android. Engaging gameplay, stunning graphics, monetization strategies. From concept to App Store success with Unity and Unreal Engine.",
    canonicalUrl: "https://404codelab.com/services/game-development"
  };
